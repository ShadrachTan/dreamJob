  ...
  <div class="form">
    <form action="core/handleForms.php" method="POST">
      ...
      <p>
        ...
        <input type="text" name="gender" value="<?php echo $getStudentId['gender']; ?>" readonly>
      </p>
      <p>
        <label for="yearLevel">Year Level</label>
        <input type="text" name="yearLevel" value="<?php echo $getStudentId['year_level']; ?>" readonly>
      </p>
      <p>
        <label for="dream">Dream</label>
        <input type="text" name="dream" value="<?php echo $getStudentId['dream']; ?>" readonly>
      </p>
      <p>
        <label for="religion">Religion</label>
        <input type="text" name="religion" value="<?php echo $getStudentId['religion']; ?>" readonly>
      </p>
